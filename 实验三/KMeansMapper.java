...
public class KMeansMapper extends Mapper<LongWritable, Text, Text, Text> {
    ...
    protected void setup(Context context) throws IOException, InterruptedException {
        ...
        Path centerFilePath = new Path("/kmeans/input/dataset/initial_centers.data");
        try (BufferedReader br = new BufferedReader(new InputStreamReader(fs.open(centerFilePath)))) {
            String line;
